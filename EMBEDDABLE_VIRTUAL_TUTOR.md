...
`<TOKEN>` | The login token generated for your users to securely access the Embeddable Virtual Tutor | Must be generated using the public API [genTokenForEmbeddableVirtualTutorGuest](https://github.com/qurami/smart-notes-api-quickstart#generate-a-token-for-external-users-to-access-the-embeddable-virtual-tutor).
