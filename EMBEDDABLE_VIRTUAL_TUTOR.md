...
<TOKEN> | The token related to the company guest user, which will be used to log the guest user into the Embeddable Virtual Tutor. | Must be generated using the public API [genTokenForEmbeddableVirtualTutorGuest](https://github.com/qurami/smart-notes-api-quickstart#generate-a-token-to-login-into-embeddable-virtual-tutor-for-an-external-user).
